<x-app-layout>
    ...
    <div class="py-4">
        <div class="max-w-10xl mx-auto sm:px-6 lg:px-8">
            {{-- Tombol Export --}}
            <form action="{{ route('penelitian_dosen.export.csv') }}" method="GET" class="mb-4">
            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-lg p-6">
                <table id="penelitianTable" class="display min-w-full bg-white border border-gray-500">
                    <thead>
                        <tr>
                ...
                @if($penelitian_dosen->isEmpty())
                    <p class="text-center text-gray-500 mt-4">Tidak ada data penelitian dosen.</p>
                @endif
            </div>
        </div>
    </div>
