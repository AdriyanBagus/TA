<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('lahan_praktek.export.csv') }}" method="GET" class="mb-4">
            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-lg p-6">
                <table id="lahanPraktekTable" class="display min-w-full bg-white border border-gray-500">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 border">Kontribusi Lahan Praktek</th>
                        </tr>
                    </thead>
                    <tbody>
