<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <form method="GET" action="{{ route('pkm_mahasiswa') }}"
    ...
    <div class="py-4">
        <div class="max-w-10xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-lg p-6">
                <table id="pkmMahasiswaTable" class="display min-w-full bg-white border border-gray-500">
                    <thead>
                        <tr>
                            <th class="px-4 py-2 border">No</th>
                            <th class="px-4 py-2 border">Nama Prodi</th>
                            <th class="px-4 py-2 border">Mahasiswa</th>
                            <th class="px-4 py-2 border">Pembimbing</th>
                ...
                @if($pkm_mahasiswa->isEmpty())
                    <p class="text-center text-gray-500 mt-4">Tidak ada data PKM Mahasiswa.</p>
                @endif
            </div>
        </div>
    </div>
