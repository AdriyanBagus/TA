<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            {{-- Dropdown Filter Tahun Akademik & Prodi --}}
    ...
    <div class="py-4">
        <div class="max-w-10xl mx-auto sm:px-6 lg:px-8">
            {{-- Tombol Export --}}
            <form action="{{ route('rekognisi_tenaga_kependidikan.export.csv') }}" method="GET" class="mb-4">
            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-lg p-6">
                <table id="rekognisiTable" class="display min-w-full bg-white border border-gray-500">
                    <thead>
                        <tr>
                ...
                @if($rekognisi_tenaga_kependidikan->isEmpty())
                    <p class="text-center text-gray-500 mt-4">Tidak ada data rekognisi yang terdaftar.</p>
                @endif
            </div>
        </div>
    </div>
