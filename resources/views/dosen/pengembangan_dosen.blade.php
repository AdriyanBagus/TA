    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-2 md:space-y-0">
            ...
            <div class="flex items-center space-x-4 mt-4">
                ...
                <form method="GET" action="{{ route('dosen.pengembangan_dosen') }}"
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('dosen.pengembangan_dosen.export') }}" class="btn btn-success btn-sm"
                            ...
                            <tr>
                                ...
                                <td class="px-1 py-3 border flex flex-col items-center space-y-2 text-sm">
                                    ...
                                    <button
                                        ...
                                        data-bs-target="#exampleModal{{ $pengembangandosen->id }}">
                                        Edit
                                    </button>

                                    <!-- Tombol Delete -->
                                    <form
                                        action="{{ route('dosen.pengembangan_dosen.destroy', $pengembangandosen->id) }}"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form
                                                action="{{ route('dosen.pengembangan_dosen.update', $pengembangandosen->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nidn"
                                                        name="nidn" value="{{ $pengembangandosen->nidn }}" readonly>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="waktu_pelaksanaan"
                                                        ...
                                                        value="{{ $pengembangandosen->waktu_pelaksanaan }}">
                                                </div>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('dosen.pengembangan_dosen.add') }}" method="POST">
                                    @csrf
