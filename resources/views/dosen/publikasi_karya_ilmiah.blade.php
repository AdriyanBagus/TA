    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-2 md:space-y-0">
            ...
            <div class="flex items-center space-x-4 mt-4">
                <form method="GET" action="{{ route('dosen.publikasi_karya_ilmiah') }}"
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('dosen.publikasi_karya_ilmiah.export') }}" class="btn btn-success btn-sm"
        ...
        <div class="max-w-10xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl rounded-lg p-3">
                <table class="min-w-full bg-white border border-gray-500">
                    ...
                    <tbody>
                        @forelse ($publikasi_karya_ilmiah as $publikasi)
                            <tr>
                                ...
                                <td class="px-1 py-3 border flex flex-col items-center space-y-2">
                                    ...
                                    <form action="{{ route('dosen.publikasi_karya_ilmiah.destroy', $publikasi->id) }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content" x-data="{ jenis: '{{ $publikasi->jenis }}' }">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Publikasi Karya Ilmiah</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('dosen.publikasi_karya_ilmiah.update', $publikasi->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3"><label class="form-label">Judul Penelitian:</label>
                                <textarea class="form-control" name="judul_penelitian" required>{{ $publikasi->judul_penelitian }}</textarea>
                            </div>
    ...
    <div class="modal fade" id="tambahPublikasiModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Publikasi Karya Ilmiah</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('dosen.publikasi_karya_ilmiah.add') }}" method="POST"
                        x-data="{ jenis: '' }">
                        @csrf

                        <div class="mb-3"><label class="form-label">Judul Penelitian:</label>
                            <textarea class="form-control" name="judul_penelitian" required>{{ old('judul_penelitian') }}</textarea>
                        </div>
                        <div class="mb-3"><label class="form-label">Judul Publikasi:</label>
