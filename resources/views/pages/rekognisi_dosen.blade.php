    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-2 md:space-y-0">
            ...
            <div class="flex items-center space-x-4 mt-4">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('pages.rekognisi_dosen.export') }}" class="btn btn-success btn-sm" onclick="return confirm('Apakah Anda yakin ingin mendownload CSV?')">
                        Download CSV
                    </a>
                        ...
                        @foreach ($rekognisi_dosen as $rekognisidosen)
                            <tr>
                                ...
                                <td class="px-1 py-3 border flex flex-col items-center space-y-2 text-sm">
                                    ...
                                    <!-- Tombol Delete -->
                                    <form action="{{ route('pages.rekognisi_dosen.destroy', $rekognisidosen->id) }}"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('pages.rekognisi_dosen.update', $rekognisidosen->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nama"
                                                        name="nama" value="{{ $rekognisidosen->nama }}"
                                                        required>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="tahun_perolehan"
                                                        name="tahun_perolehan" value="{{ $rekognisidosen->tahun_perolehan }}">
                                                </div>
                                                <div class="mb-3">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('pages.rekognisi_dosen.add') }}" method="POST">
                                    @csrf
