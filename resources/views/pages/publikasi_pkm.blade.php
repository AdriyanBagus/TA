<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-2 md:space-y-0">
            ...
            <div class="flex items-center space-x-4 mt-4">
                ...
                <form method="GET" action="{{ route('pages.publikasi_pkm') }}"
                ...
                @if ($tahunTerpilih && $tahunList->where('id', $tahunTerpilih)->first()->is_active)
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('pages.publikasi_pkm.export') }}" class="btn btn-success btn-sm">
                            Download CSV
                        </a>
            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-lg p-3">
                        ...
                        @foreach ($publikasi_pkm as $publikasi)
                            <tr>
                                ...
                                <td class="px-1 py-3 border flex flex-col items-center space-y-2">
                                    ...
                                    <!-- Tombol Delete -->
                                    <form action="{{ route('pages.publikasi_pkm.destroy', $publikasi->id) }}"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Edit Publikasi PKM</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form
                                                action="{{ route('pages.publikasi_pkm.update', $publikasi->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="judul_pkm" name="judul_pkm" required>{{ $publikasi->judul_pkm }}</textarea>
                                                </div>
                                                <div class="mb-3">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Tambah Publikasi PKM</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form action="{{ route('pages.publikasi_pkm.add') }}" method="POST">
                                    @csrf
    ...
    <script>
        document.getElementById('exampleModal').addEventListener('show.bs.modal', function(event) {
            ...
            modalTitle.textContent = 'Tambah Publikasi PKM ';
